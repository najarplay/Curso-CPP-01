...
por un ciclista en una etapa la estructura debe tener 
tres campos hora, minutos y segundos escriba un 
programa que dado N etapas calcule el tiempo total 
